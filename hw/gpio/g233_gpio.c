...
static void g233_gpio_write(void *opaque, hwaddr addr, uint64_t val, unsigned size)
{
    G233GPIOState *s = opaque;
    switch (addr) {
    case 0x00: s->dir  = val; break;
    case 0x04: s->out  = val; break;
    case 0x08: break;
    case 0x0C: s->ie   = val; break;
    case 0x10: s->is  &= ~val; break;
    case 0x14: s->trig = val; break;
    case 0x18: s->pol  = val; break;
    }
}
